# ZI-E CAD v1.1 — Automated Geometry / Engineering Validation

**Result:** 36/37 checks pass. Failed checks are design restrictions or freeze gates, not silently ignored.

Estimated mass: **2.44 kg**; active estimated COM: **(-0.7, -2.4, 91.0) mm**.
...
| Estimated total mass | 2444 | informational | PASS |
| Baseline static support margin | 20.4 | >= 18 mm | PASS |
| One-arm 250g forward static margin | 19.8 | >= 15 mm | PASS |
| Two-arm 2x250g forward static margin | 12.0 | >= 15 mm for normal driving | RESTRICT / VERIFY |
