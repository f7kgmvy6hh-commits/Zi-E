# ZI-E CAD v0.3 — Prototype Engineering Release
...
```bash
python src/render_gltf.py cad/ZI-E_v0_3_ACTIVE.gltf renders/ZI-E_v0_3_ACTIVE_iso.png 35 18
```
...
Dedicated VL53L1X Class-1 laser ToF rangefinder envelope is included beside the centered OV5640 camera. Prototype carrier envelope is reserved; final bare-sensor PCB can shrink substantially. See `docs/LASER_RANGEFINDER_DESIGN.md`.
