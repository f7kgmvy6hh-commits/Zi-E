...
Optionally enable Camofox with `ZIE_CAMOFOX_ENABLED=true`; the launcher accepts only
the fixed executable name `camofox`, with no shell expression or caller arguments. Start with
