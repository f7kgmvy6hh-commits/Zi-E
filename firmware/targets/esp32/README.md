...
This is a disabled ESP-IDF composition boundary, not a board binding. Configure fails
unless the caller supplies a repository-reviewed board profile containing
`ZIE_BOARD_PROFILE_VERIFIED=TRUE` and an active official ESP-IDF environment.
